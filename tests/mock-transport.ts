...
import { BigIntService, CountResponseSchema } from "./gen/bigint_pb.js";
import type { SayRequest } from "./gen/eliza_pb.js";
import { ElizaService, SayResponseSchema } from "./gen/eliza_pb.js";
    ...
    ({ service }) => {
      service(ElizaService, {
        say: async (input: SayRequest) => {
          ...
          return create(SayResponseSchema, override ?? { sentence: `Hello ${input.sentence}` });
        },
      });
    },
    {
