 ...
 */
export const file_bigint: GenFile /*@__PURE__*/ = fileDesc(
 ...
 */
export const CountRequestSchema: GenMessage<CountRequest> /*@__PURE__*/ = messageDesc(
  file_bigint,
  0,
);
 ...
 */
export const CountResponseSchema: GenMessage<CountResponse> /*@__PURE__*/ = messageDesc(
  file_bigint,
  1,
);
