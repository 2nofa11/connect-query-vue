...
![API Coverage](https://img.shields.io/badge/API%20Coverage-30%25-red)

Implements **30%** (3/10) of the exports from the official [`@connectrpc/connect-query`](https://github.com/connectrpc/connect-query-es).
